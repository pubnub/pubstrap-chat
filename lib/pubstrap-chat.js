    ...
    var Chat = function($target, options) {
      ...
      var Message = function(type, data, message) {
        ...
        if(type == "message") {
          ...
          self.$tpl = $('<li class="list-group-item message"><strong class="username">' + options.username_from_data(data) + ':</strong><span class="text">' + message + '</span></li>');
      ...
      var User = function(id) {
        ...
        self.init = function() {
          ...
          options.data_from_id(self.id, function(data) {
